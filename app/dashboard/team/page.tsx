      ...
      <div className="p-4 space-y-6">
        ...
        <div className="bg-slate-900 rounded-[40px] p-8 shadow-2xl text-center relative overflow-hidden neo-card">
           ...
           <div className="grid grid-cols-4 gap-4">
               <ShareIcon icon={<div className="w-14 h-14 rounded-2xl overflow-hidden shadow-lg"><img src="/tg.png" alt="T" className="w-full h-full object-cover" /></div>} label="Telegram" color="transparent" />
               ...
               <ShareIcon 
                 ...
                 icon={<div className="w-14 h-14 rounded-2xl overflow-hidden shadow-lg opacity-40"><img src="/nb.png" alt="S" className="w-full h-full object-cover grayscale" /></div>} 
                 label="COMING SOON" 
                 color="transparent" 
               />
