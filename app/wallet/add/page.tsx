...
import { CreditCard, ArrowLeft, Zap, Upload, CheckCircle, RefreshCw, AlertCircle, Info } from 'lucide-react';
          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                ...
                <h1 className="text-4xl font-black italic tracking-tighter mb-2">Neural Recharge</h1>
